"""Tests for provider-scoped dataset listing on the StatGPT SDMX proxy."""
...
async def test_sdmx21_list_providers_falls_back_to_id_when_localized_name_missing() -> None:
