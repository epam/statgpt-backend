...
from statgpt.common.utils.cache import Cache


class TestCacheRemove:
    """Tests for the Cache.remove() method."""

    def test_remove_existing_key(self) -> None:
        cache: Cache[str] = Cache(ttl=60)
...
class TestCacheGetSetBasics:
    """Basic tests for Cache get/set behavior."""
