...
if t.TYPE_CHECKING:
    from statgpt.schemas.query_builder import LLMSelectionDimensionCandidate
...
class LLMSelectionCandidateBase(BaseModel, ABC):
    ...
    @staticmethod
    @abstractmethod
    def candidates_to_llm_string(candidates: list["LLMSelectionDimensionCandidate"]) -> str:
        raise NotImplementedError
