...
from .discovery_datasets import channel_discovery_datasets_router, discovery_datasets_router
...
channel_router.include_router(channel_discovery_datasets_router)
