...
async def get_data_sources(
    ...
    data_sources = await service.get_data_sources_schemas_with_proxy_config(
...
async def get_data_source_by_id(
    ...
    return await DataSourceService(session).get_schema_by_id_with_proxy_config(item_id)
