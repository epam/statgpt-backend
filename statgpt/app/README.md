...
| CMD_DISCOVERY_PREFILTER_ONLY                 |    No    | Whether to stop a data query right after the Grade C discovery pre-filter (the pre-filter eval's isolated mode)                                                                                                                                      | `true`, `false`                              | `false`             |
