...
class ChannelCompletion(ChatCompletion):
    ...
    def init_state(request: Request) -> dict:
        defaults = {
            ...
            StateVarsConfig.CMD_SKIP_GUARDRAILS: False,
            StateVarsConfig.CMD_OUT_OF_SCOPE_ONLY: False,
            StateVarsConfig.CMD_RAG_PREFILTER_ONLY: False,
            StateVarsConfig.CMD_SKIP_DATA_QUERY_SUMMARIZATION: False,
            StateVarsConfig.CMD_SKIP_TOOLS_EXECUTION: False,
        }
