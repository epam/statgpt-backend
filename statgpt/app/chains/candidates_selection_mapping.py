...
from statgpt.app.schemas import CandidatesRelevancyMapping
from statgpt.app.services.chat_facade import ScoredCandidate
...
class CandidatesSelectionMappingChainFactory(BatchedSelectionInnerChainFactory):
    ...
    def _route_based_on_candidates_presence(
        ...
        ).with_structured_output(schema=CandidatesRelevancyMapping, method="json_schema")
        chain = (
    ...
    def _format_candidates(self, inputs: dict) -> str:
        ...
        text = ScoredCandidate.convert_candidates_to_llm_string(candidates)
        return text
