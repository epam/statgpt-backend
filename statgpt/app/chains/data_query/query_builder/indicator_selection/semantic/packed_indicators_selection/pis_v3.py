...
from statgpt.app.chains.candidates_selection_batched import (
...
from statgpt.common.data.sdmx.common.indicator import ComplexIndicatorComponentDetails
...
'''
    ...
    class BatchedSelectionOutput(BatchedSelectionOutputBase):
        ...
        @classmethod
        def combine_batch_outputs(  # type: ignore[override]
    ...
    def _remove_hallucinations(self, inputs: dict) -> dict:  # type: ignore[override]
        parsed_response: PackedIndicatorsSelectionV3InnerChainFactory.LLMResponse = inputs[self.PARSED_RESPONSE_KEY]  # type: ignore[name-defined]
        ...
        for ix in list(res_filtered.keys()):
            ...
            if hallucinated_codes:
                ...
                res_filtered[ix] = list(selected_detail_codes)
    ...
    def _convert_to_queries(self, inputs: dict) -> DatasetDimQueries:
        ...
        dataset_dim_queries_dict: dict[str, dict[str, set[str]]] = {}
        ...
        for dataset_id, dim_queries in dataset_dim_queries_dict.items():
            for dim_id in dim_queries:
                dim_queries[dim_id] = list(dim_queries[dim_id])  # type: ignore[assignment]
