...
from statgpt.common.auth.authorizer import (
    DialUserAuthorizer,
...
from statgpt.common.auth.grants import (
    AuthorizationError,
...
from statgpt.common.auth.msi import CachedMsiAuthorizer
from statgpt.common.auth.token_cache import GlobalTokenCache
from statgpt.common.config import logger as logger
from statgpt.common.data.quanthub.config import AuthConfig, AuthGrantType, UserAuthType
from statgpt.common.data.sdmx.common.authorizer import IAuthorizer
from statgpt.common.settings.auth import clients_spa_chat_settings, dial_chat_settings
...
class QuanthubAuthorizer(IAuthorizer):
    ...
    async def _authorize(self) -> str:
        if self._auth_context.is_system:
            logger.debug('Authorizing as system user')
